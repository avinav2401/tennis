...
export class Court {
    ...
    render() {
        ...
        // render blue field above the white base
        const field = [];
        const fieldMaterial = new THREE.MeshBasicMaterial({ color: 0x0066CC, side: THREE.DoubleSide });
        ...
        const shadowMaterial = new THREE.MeshBasicMaterial({ color: 0x003366, side: THREE.DoubleSide });
